...
class codeforces extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<ContestData>?> cfcall() async {
      ...
      response =
          await http.get(Uri.parse("https://kontests.net/api/v1/codeforces"));
            ...
            return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromARGB(255, 99, 157, 207),
                ),
                child: Column(
                  children: [
                    Padding(
                    ...
                    Row(
                     ...
                     Row(
                      children: [
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("Duration : ${int.parse(data![index].duration) / 3200} hour", style: TextStyle(color: Colors.white),),
                        ),
                      ],
                    ),
                    Padding(
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('CodeForces', style: TextStyle(color: Colors.white)),
        ),
        body: value(),
      )
    );
